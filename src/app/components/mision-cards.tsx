...
function MisionCards () {
  return (
    <div className="grid grid-cols-1 sm-2:grid-cols-3 auto-rows-[390px] md:auto-rows-[270px] lg:auto-rows-[360px] xl:auto-rows-[540px]">
      <div className="flex flex-col gap-y-5 items-center justify-center bg-protop-light-blue p-5 lg:py-10 lg:px-20 text-center">
      ...
      <div className="flex flex-col gap-y-5 items-center justify-center bg-blue-grad-reverse sm-2:bg-blue-gradient py-5 px-8 lg:py-10 lg:px-20 text-center">
      ...
      <div className="flex flex-col gap-y-5 items-center justify-center bg-protop-light-blue py-5 px-8 lg:py-10 lg:px-20 text-center">
