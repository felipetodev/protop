  ...
  return (
    <Layout className="grid grid-cols-1 sm-2:grid-cols-2 gap-x-10 xl:pt-20 overflow-hidden">
      <div className="flex flex-col mt-10 md:mt-36 gap-10 items-center sm-2:items-start text-center sm-2:text-start">
        <h1 className="text-[35px] md:text-[55px] lg:text-[75px] font-semibold [text-wrap:balance] text-protop-lavander leading-tight">
        ...
        <ul className="gap-8 gap-y-3 hidden sm-2:grid sm-2:grid-cols-2 lg:hidden text-[11px] sm-2:text-[13px]">
          <li>
