  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 auto-rows-[390px] md:auto-rows-[405px] lg:auto-rows-[540px] xl:auto-rows-[375px] text-protop-space bg-protop-lavander overflow-hidden">
      <MotionDiv
        variants={showUp}
        transition={{ bounce: 0 }}
        className="bg-protop-lavander p-5 md:p-10"
      >
      ...
      <MotionDiv
        variants={showUp}
        transition={{ delay: 0.25, bounce: 0 }}
        className="bg-gray-grad-reverse md:bg-gray-gradient p-5 md:p-10"
      >
        <div className="flex space-x-2">
          <div className="w-8 h-8 rounded-full bg-protop-space" />
          <div className="flex flex-col gap-y-1">
      ...
      <MotionDiv
        variants={showUp}
        transition={{ delay: 0.75, bounce: 0 }}
        className="bg-gray-grad-reverse md:bg-gray-gradient p-5 md:p-10"
      >
        <div className="flex space-x-2">
          <div className="w-8 h-8 rounded-full bg-protop-space" />
